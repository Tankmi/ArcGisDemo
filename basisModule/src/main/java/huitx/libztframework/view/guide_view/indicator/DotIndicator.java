package huitx.libztframework.view.guide_view.indicator;
...
import huitx.libztframework.view.guide_view.interf.GIndicator;
...
public class DotIndicator extends LinearLayout implements GIndicator {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.dotRes = ta.getResourceId(R.styleable.GuideIndicator_dot, R.drawable.guide_indicator_view);
