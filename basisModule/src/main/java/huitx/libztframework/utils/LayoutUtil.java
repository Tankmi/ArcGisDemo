...
//    }
    ...
    public void drawViewRBConstraintTBLayout(View view, float marginTop, float marginBottom) {
        view.setLayoutParams(getLayoutParam((ConstraintLayout.LayoutParams) view.getLayoutParams(), -1, -1, -1, -1, marginTop, marginBottom));
    }

    public void drawViewRBConstraintLayout(View view, float width, float height) {
        view.setLayoutParams(getLayoutParam((ConstraintLayout.LayoutParams) view.getLayoutParams(), width, height, -1, -1, -1, -1));
    }

    public void drawViewRBConstraintLayout(View view, float width, float height, float marginleft, float marginright, float marginTop, float marginBottom) {
        view.setLayoutParams(getLayoutParam((ConstraintLayout.LayoutParams) view.getLayoutParams(), width, height, marginleft, marginright, marginTop, marginBottom));
    }
    ...
    /** 用于设置不需要根据屏幕宽高比进行缩放的图标，按钮等的尺寸与相对位置 */
    public void drawViewDefaultConstraintLayout(View view, int width, int height, int marginleft, int marginright, int marginTop, int marginBottom) {
        view.setLayoutParams(getDefaultLayoutParam((ConstraintLayout.LayoutParams) view.getLayoutParams(), width, height, marginleft, marginright, marginTop, marginBottom));
    }
    ...
    public void drawViewRBLinearLayout(View view, float width, float height) {
        view.setLayoutParams(getLayoutParam((LinearLayout.LayoutParams) view.getLayoutParams(), width, height, -1, -1, -1, -1));
    }

    public void drawViewRBLinearLayout(View view, float width, float height, float marginleft, float marginright) {
        view.setLayoutParams(getLayoutParam((LinearLayout.LayoutParams) view.getLayoutParams(), width, height, marginleft, marginright, -1, -1));
    }
    ...
    public void drawViewRBFrameLayout(View view, float width, float height, float marginleft, float marginright, float marginTop, float marginBottom) {
        view.setLayoutParams(getLayoutParam((FrameLayout.LayoutParams) view.getLayoutParams(), width, height, marginleft, marginright, marginTop, marginBottom));
    }
    ...
    private FrameLayout.LayoutParams getLayoutParam(FrameLayout.LayoutParams params, float width, float height, float marginleft, float marginright, float marginTop, float marginBottom) {
...
//    }
    ...
    private ConstraintLayout.LayoutParams getLayoutParam(ConstraintLayout.LayoutParams params, float width, float height, float marginleft, float marginright, float marginTop, float marginBottom) {
        if (width != -1 && width != 0) params.width = (int) (ScreenWidth * (width / normalW));
    ...
    private ConstraintLayout.LayoutParams getDefaultLayoutParam(ConstraintLayout.LayoutParams params, int width, int height, int marginleft, int marginright, int marginTop, int marginBottom) {
        if (width != -1) params.width = width;
        if (height != -1) params.height = height;
        if (marginleft != -1) params.leftMargin = marginleft;
        if (marginright != -1) params.rightMargin = marginright;
